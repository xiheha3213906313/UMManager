...
namespace UMManager.WinUI.Services.AppManagement.Updating;
...
public class AutoUpdaterService
{
    ...
    public const string AutoUpdaterFolder = "UMManager - Auto Updater";
    public const string NewAutoUpdaterFolder = "UMManager - Auto Updater_New";
    public const string AutoUpdaterExe = "UMManager - Auto Updater.exe";
