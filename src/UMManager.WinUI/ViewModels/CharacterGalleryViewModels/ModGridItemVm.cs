...
namespace UMManager.WinUI.ViewModels.CharacterGalleryViewModels
{
    public class ModGridItemVm : ObservableObject
    {
        ...
        public string DateAddedView => $"Added to UMManager on: {DateAdded}";
        ...
        public IAsyncRelayCommand SaveImageCommand => new AsyncRelayCommand(async () =>
        {
            ...
            catch (Exception e)
            {
                ...
                notificationService.ShowNotification(
                    localizer.GetLocalizedStringOrDefault("Notification.SaveImageFailed.Title", defaultValue: "保存图片失败"),
                    e.Message,
                    null);
            }
        },
