        ...
        await CommandWrapperAsync(true, async () =>
        {
            ...
            catch (Exception e)
            {
                ...
                _notificationService.ShowNotification(
                    _localizer.GetLocalizedStringOrDefault("Notification.AddStorageItemsError.Title", defaultValue: "添加文件失败"),
                    string.Format(_localizer.GetLocalizedStringOrDefault("Notification.AddStorageItemsError.Message",
                            defaultValue: "添加所选文件时发生错误：\n{0}")!,
                        e.Message),
