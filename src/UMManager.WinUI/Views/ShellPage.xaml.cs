...
public sealed partial class ShellPage : Page
{
    ...
    private void GameServiceOnInitialized(object? sender, EventArgs e)
    {
        App.MainWindow.DispatcherQueue.TryEnqueue(() =>
        {
            ...
            {
                if (category.ModCategory is ModCategory.NPC or ModCategory.Object or ModCategory.Weapons)
                    continue;
        ...
        App.MainWindow.DispatcherQueue.EnqueueAsync(async () =>
        {
            ...
            foreach (var game in notSelectedGame.Reverse())
            {
                ...
                var gameInfo = await GameService.GetGameInfoAsync(game, languageCode);
