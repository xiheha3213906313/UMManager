...
using UMManager.WinUI.Helpers.Xaml;
...
namespace UMManager.WinUI.Views.CharacterDetailsPages;
...
public sealed partial class CharacterDetailsPage : Page
{
    ...
    private void OnModObjectLoaded(object? sender, EventArgs e)
    {
        ...
        {
            Content = localizer.GetLocalizedStringOrDefault("Tooltip.Character.SingleSkin",
                defaultValue: "该角色只有一个默认游戏内皮肤，因此无法切换。"),
