...
using UMManager.Core.Services.CommandService.JsonModels;
using UMManager.Core.Services.CommandService.Models;
using Serilog;
using static UMManager.Core.Services.CommandService.RunningCommandChangedEventArgs;

namespace UMManager.Core.Services.CommandService;
