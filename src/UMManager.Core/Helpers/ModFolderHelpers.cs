...
public static class ModFolderHelpers
{
    ...
    {
        return entry.StartsWith(Constants.InternalFilePrefix, StringComparison.OrdinalIgnoreCase) ||
               entry.StartsWith(Constants.LegacyInternalFilePrefix, StringComparison.OrdinalIgnoreCase);
    }

    public static bool IsJASMFileEntry(FileSystemInfo entry)
    {
        return entry.Name.StartsWith(Constants.InternalFilePrefix, StringComparison.OrdinalIgnoreCase) ||
               entry.Name.StartsWith(Constants.LegacyInternalFilePrefix, StringComparison.OrdinalIgnoreCase);
    }
}
