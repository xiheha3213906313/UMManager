...
public interface IGameService
{
    ...
    public Task UpdateCharacterAsync(InternalName internalName, UpdateCharacterRequest request);

    public Task<ICharacter> RenameCharacterAsync(InternalName internalName, InternalName newInternalName);

    public Task<ICharacter> DeleteCharacterAsync(InternalName internalName);
    ...
    public Task AddCharacterSkinAsync(InternalName characterInternalName, AddCharacterSkinRequest request);

    public Task SetCharacterSkinImageAsync(InternalName characterInternalName, InternalName skinInternalName, Uri image);

    public Task SetCharacterSkinDisplayNameAsync(InternalName characterInternalName, InternalName skinInternalName, string displayName);

    public Task DeleteCharacterSkinAsync(InternalName characterInternalName, InternalName skinInternalName);
    ...
    public Task<IReadOnlyList<UiCategory>> GetUiCategoriesAsync();
    public Task<UiCategory> CreateUiCategoryAsync(string name, Uri? image);
    public Task<UiCategory> UpdateUiCategoryAsync(Guid categoryId, UpdateUiCategoryRequest request);
    public Task DeleteUiCategoryAsync(Guid categoryId);
