...
namespace UMManager.Core.Contracts.Services;
...
public interface ISkinManagerService : IDisposable
{
    ...
    public Task SyncCharacterFolderNameAsync(IModdableObject moddableObject, string previousDisplayName);

    public Task RenameCharacterInternalNameAsync(InternalName oldInternalName, InternalName newInternalName);

    public Task SyncCharacterSkinFolderNameAsync(IModdableObject moddableObject, InternalName skinInternalName, string displayName);
